...
Future<void> main() async {
  ...
  if(Platform.isIOS) {
    ...
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyAk6b0oa0F6AOY-2MTIHlEweRSljtt_Kos', //current_key
      appId: '1:480211706047:android:f1f0be06ebec83af0a660a', // mobilesdk_app_id
      messagingSenderId: '480211706047', // project_number
      projectId: 'tastivo-43543', // project_id
    ));
